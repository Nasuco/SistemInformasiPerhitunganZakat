            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-header text-center">
                        <h5 class="mb-0">Edit Zakat Beras</h5>
                    </div>
                    <hr class="horizontal dark mt-0">
                    <div class="card-body">
                        <form action="{{ route('beras.update', ['zakatBeras' => $zakatBeras->id]) }}" method="post">
                            @csrf
                                    ...
                                    <div class="col-md-8 mb-3 mb-md-0">
                                        <select class="form-control" id="muzakki_select" name="muzakki_id">
                                            ...
                                            @foreach ($muzakkis as $muzakki)
                                                <option value="{{ $muzakki->id }}" @if($muzakki->id == $zakatBeras->muzakki_id) selected @endif>{{ $muzakki->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kilogram" name="kilogram" value="{{ $zakatBeras->kilogram }}" required>
                                @error('kilogram')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jumlah_keluarga" name="jumlah_keluarga" value="{{ $zakatBeras->jumlah_keluarga }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_penerimaan" name="tanggal_penerimaan" value="{{ $zakatBeras->tanggal_penerimaan }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ $zakatBeras->keterangan }}</textarea>
                                @error('keterangan')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>

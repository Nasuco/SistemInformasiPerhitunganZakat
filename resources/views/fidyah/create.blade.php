            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-header text-center">
                        <h5 class="mb-0">Tambah Fidyah</h5>
                    </div>
                    <hr class="horizontal dark mt-0">
                    <div class="card-body">
                        <form action="{{ route('fidyah.store') }}" method="post" id="fidyahForm">
                            @csrf
                            <div class="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jumlah_rupiah" name="jumlah_rupiah" value="" placeholder="0" required>
                                @error('jumlah_rupiah')

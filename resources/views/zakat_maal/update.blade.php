        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('maal.update', ['zakatMaal' => $zakatMaals->id]) }}" method="post">
                            @csrf
                                    ...
                                    <div class="col-md-8 mb-3 mb-md-0">
                                        <select class="form-control" id="muzakki_select" name="muzakki_id">
                                            ...
                                            @foreach ($muzakkis as $muzakki)
                                                <option value="{{ $muzakki->id }}" @if($muzakki->id == $zakatMaals->muzakki_id) selected @endif>{{ $muzakki->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jumlah_rupiah" name="jumlah_rupiah" value="{{ $zakatMaals->jumlah_rupiah }}" required>
                                @error('jumlah_rupiah')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_penerimaan" name="tanggal_penerimaan" value="{{ $zakatMaals->tanggal_penerimaan }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ $zakatMaals->keterangan }}</textarea>
                                @error('keterangan')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
